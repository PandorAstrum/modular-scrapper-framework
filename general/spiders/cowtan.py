...
class CowtanSpider(scrapy.Spider):
    name = 'cowtan'
    allowed_domains = ['www.cowtan.com']

    def __init__(self, **kwargs):
        super(CowtanSpider, self).__init__(**kwargs)
        ...
        self.start_urls = ['http://www.cowtan.com/']
    ...
    def parse(self, response):
        if self._login:
            ...
            _all_category = response.xpath('//nav[@id="brands-nav"]/a/@href').extract()
